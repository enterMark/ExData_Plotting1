...
plot(selected_usage$Date_Time, selected_usage$Global_active_power, type = "l", 
     xlab ="", ylab = "Global Active Power (kilowatts)")

plot(selected_usage$Date_Time, selected_usage$Voltage, type = "l", xlab ="datetime", ylab = "Voltage")
...
plot(selected_usage$Date_Time, selected_usage$Global_reactive_power, type = "l", xlab ="datetime", ylab = "Global_reactive_power")
